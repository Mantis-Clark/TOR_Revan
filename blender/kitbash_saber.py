...
# import the real animated saber (blade + ignition anims)
bpy.ops.kb.mdlimport(filepath=r"C:/Users/alex4/AppData/Local/Temp/whereami206/vanilla_saber.mdl")
...
# rename root and export over variation 099
root.name = MODELNAME
def sel_all(o):
    o.select_set(True)
